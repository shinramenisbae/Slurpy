...
Thank you for your interest in contributing to Slurpy! This guide will help you get started with contributing to this open source speech-to-text application.

## ⚠️ Feature Freeze

**Slurpy is currently undergoing a feature freeze.** If you are submitting a PR which is a new feature that the community has not asked for, it will be rejected. If the community has asked for it, or you have explicitly gathered support, it may still be considered.
...
Slurpy aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/Slurpy.git
   cd Slurpy
   ```

3. **Add remotes** (`upstream` is this repo; `handy` is the original project
   Slurpy is forked from, useful for pulling in changes):

   ```bash
   git remote add upstream git@github.com:shinramenisbae/Slurpy.git
   git remote add handy git@github.com:cjpais/Handy.git
   ```
...
Slurpy follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/shinramenisbae/Slurpy/issues](https://github.com/shinramenisbae/Slurpy/issues)
2. **Check discussions** at [github.com/shinramenisbae/Slurpy/discussions](https://github.com/shinramenisbae/Slurpy/discussions)
...
1. **Search existing discussions** at [github.com/shinramenisbae/Slurpy/discussions](https://github.com/shinramenisbae/Slurpy/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/shinramenisbae/Slurpy/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/shinramenisbae/Slurpy/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/shinramenisbae/Slurpy/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with Slurpy's philosophy
...
1. **Search existing issues and PRs** - Check both open AND closed issues and pull requests. Someone may have already addressed this, or there may be a reason it was closed.
   - [Open issues](https://github.com/shinramenisbae/Slurpy/issues)
   - [Closed issues](https://github.com/shinramenisbae/Slurpy/issues?q=is%3Aissue+is%3Aclosed)
   - [Open PRs](https://github.com/shinramenisbae/Slurpy/pulls)
   - [Closed PRs](https://github.com/shinramenisbae/Slurpy/pulls?q=is%3Apr+is%3Aclosed)
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/shinramenisbae/Slurpy/discussions)
   - Link to that discussion in your PR

3. **Get community feedback for features** - PRs with demonstrated community interest are **much more likely to be merged**. Start a discussion, get feedback, and link to it in your PR. This helps ensure Slurpy stays focused and useful for the most people without becoming bloated.

Community feedback is essential to keeping Slurpy the best it can be for everyone. It helps prioritize what matters most and prevents feature creep.
...
7. **Create a Pull Request**:
   - Go to the [Slurpy repository](https://github.com/shinramenisbae/Slurpy)
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/shinramenisbae/Slurpy/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/shinramenisbae/Slurpy/discussions)
- **Email**: Reach out at [contact@handy.computer](mailto:contact@handy.computer)

## 📜 License

By contributing to Slurpy, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Slurpy!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
